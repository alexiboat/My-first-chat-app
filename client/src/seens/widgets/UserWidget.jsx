...
const UserWidget = ({userId, picturePath}) => {
    ...
    const [user , setUser]= useState(null)// this will helt grab the user from the backend
             ...
             <Divider/>
               ...
               <Box p="1rem 0">
                  ...
                  <FlexBetween gap="1rem" mb="0.5rem">
                    <FlexBetween gap="1rem" >
                     <img width="25px" height="25px" src="../assets/twitter.png" alt="twitter"/>
                  ...
                  <FlexBetween gap="1rem">
                    <FlexBetween gap="1rem" >
                     <img width="25px" height="25px" src="../assets/linkedin.png" alt="linkedin"/>
